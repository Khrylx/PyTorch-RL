...
parser.add_argument('--reward-function', help='What env to use', default='Normal',type=str)
parser.add_argument(
...
"""environment"""
env = DroneEnv(random=args.env_reset_mode,seed=args.seed, reward_function_name=args.reward_function,state=args.state)
